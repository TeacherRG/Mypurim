...
const I18N = (function () {
    ...
    const TRANSLATIONS = {
        ...
        ru: {
            ...
            dedication:       'Посвящается юбилею семьи Гринберг и её детям — Йосеф Ицхаку, Шейне, Аарону и Рахель',
        ...
        uk: {
            ...
            progressLabel:    'завершено',
            dedication:       'Присвячується ювілею родини Грінберг та її дітям — Йосеф Іцхаку, Шейне, Аарону та Рахель',
        ...
        de: {
            ...
            dedication:       'Gewidmet dem Jubiläum der Familie Grinberg und ihren Kindern — Yosef Yitzchak, Sheina, Aharon und Rachel',
